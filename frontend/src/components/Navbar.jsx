...
const Navbar = () => {
  ...
  return (
    /* 1. Added 'relative z-40' to ensure the Navbar stays above the Hero section */
    <div className="relative flex items-center justify-between py-5 font-medium z-40">
      ...
      {/* 2. Added 'fixed' and 'z-50' to ensure the sidebar covers everything on the screen */}
